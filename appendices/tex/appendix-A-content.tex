...
that is a frontier in the usual multi-objective sense: it collects the admitted
rows that no other admitted row dominates on both $Q$ and $T$, in the formal
sense stated in the main text.
%
...
union bound would give $1-28e$ as a lower bound on success. The $\hat p'_{\mathrm{LB}}$ plotted in
\Cref{M:fig:qxt-shor-comparison} instead substitutes the empirical
...
where scalarization conceals useful operating points. Only two of the eight
admitted Pareto points are promoted. The other six are rejected

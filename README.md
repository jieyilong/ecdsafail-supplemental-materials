# ECDSA.Fail supplemental materials

Supplemental materials for the ECDSA.Fail paper.

The paper cites these materials as *Supplemental Notes A--F*:
...
- [`appendices/`](appendices/): Supplemental Notes A--C -- detailed results,
  optimization taxonomy, and the accepted-solution census. LaTeX sources in
  [`appendices/tex/`](appendices/tex/).
- [`circuit_details/`](circuit_details/): Supplemental Notes D--F -- technical
  notes for selected circuit implementations.
- [`frontier_reconstruction/`](frontier_reconstruction/): frozen public data,
  reconstruction code, tests, and figures for the paper's 50% data cutoff.

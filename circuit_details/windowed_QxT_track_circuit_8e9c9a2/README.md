...
The implementation is maintained on branch `codex/windowed-8e9c9a2-precomputed-3x` of `jieyilong/ecdsafail-challenge`. The note records the runtime table ABI, QROM construction, direct precomputed-`3x_j` Stage-3 lookup, coherent identity handling, exact payload replay, circuit-to-source correspondence, measured resources, resumable evaluation procedure, and validation scope.

...
Validation only & \code{eval\_circuit.rs}: window case generation, runtime table initialization, parallel checkpointing, and correlated sequence runner & Supplies arbitrary table values and verifies coordinates, address, incremental phase, and non-interface ancillas. These changes do not alter the emitted circuit. \\
\bottomrule
\end{tabularx}

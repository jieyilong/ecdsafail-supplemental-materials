...
% ============================================================================
% Page 5: phase 1, coordinate differences
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);
  ...
  \node[detail, anchor=north east, text width=70mm, minimum height=12mm] at (32.0,17.75)
    {\textbf{Phase 1 optimization stack}\\[0.8mm]
...
% ============================================================================
% Page 6: phase 1 implementation details
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);
...
% ============================================================================
% Page 7: phase 2, dialog-GCD division
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);
  ...
  \node[detail, anchor=north east, text width=70mm, minimum height=12mm] at (32.0,16.95)
    {\textbf{Phase 2 optimization stack}\\[0.8mm]
...
% ============================================================================
% Page 8: Jump-2 step used inside phase 2
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);
...
% ============================================================================
% Page 9: base-5 codec and streamed replay used inside phase 2
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);

  \node[font=\LARGE\bfseries] at (17.15,18.0)
    {Phase 2 detail: base-$5$ codec and streamed dialog replay};
  \node[font=\large] at (17.15,17.28)
...
% ============================================================================
% Page 10: width scheduling and temporary reuse used inside phase 2
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);
...
% ============================================================================
% Page 11: phase 3, prepare X workspace
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);
  ...
  \node[detail, anchor=north east, text width=70mm, minimum height=12mm] at (32.0,17.75)
    {\textbf{Phase 3 optimization stack}\\[0.8mm]
...
% ============================================================================
% Page 12: phase 4, specialized square
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);
  ...
  \node[detail, anchor=north east, text width=70mm, minimum height=12mm] at (32.0,17.75)
    {\textbf{Phase 4 optimization stack}\\[0.8mm]
...
% ============================================================================
% Page 13: phase 4 detail, symmetry-aware streamed Karatsuba square
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);

  \node[font=\LARGE\bfseries] at (17.15,18.0)
    {Phase 4 detail: symmetry-aware streamed Karatsuba squaring};
  \node[font=\large] at (17.15,17.28)
...
% ============================================================================
% Page 14: phase 5, forward multiplication via dialog-GCD replay
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);
  ...
  \node[detail, anchor=north east, text width=70mm, minimum height=12mm] at (32.0,16.95)
    {\textbf{Phase 5 optimization stack}\\[0.8mm]
  ...
  \node[font=\large\bfseries, anchor=west] at (2.4,4.37)
    {Why dialog-GCD implements multiplication in Phase 5};
  \node[note, anchor=west, font=\small] at (2.55,3.78)
    {Phase 2 realizes the in-place division unitary};
  ...
  \node[note, text width=13.2cm, align=center, font=\small] at (9.25,1.48)
    {Thus Phase 5 reuses the low-space division construction in reverse; it does not compute $X^{-1}$.};
  \node[note, text width=13.6cm, align=left, anchor=north west, font=\small]
    at (17.55,3.87)
    {Here $X=x_A-x_{R'}$.  Phase 2's transcript described the different operand $d_x=x_R-x_A$ and was consumed during cleanup.  Phase 5 therefore constructs a fresh $\tau(X)$, whose reverse replay supplies the $X$-dependent coefficient updates that transform $\lambda$ into $\lambda X$ while restoring $X$.};
...
% ============================================================================
% Page 15: phase 6, recover affine output
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);
  ...
  \node[detail, anchor=north east, text width=70mm, minimum height=12mm] at (32.0,17.75)
    {\textbf{Phase 6 optimization stack}\\[0.8mm]

...
% ============================================================================
% Page 3: phase 1, coordinate differences
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);
...
% ============================================================================
% Page 4: phase 2, dialog-GCD division
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);
...
% ============================================================================
% Detail page: Jump-2 step used inside phase 2
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);
...
% ============================================================================
% Detail page: K5 codec and streamed replay used inside phase 2
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);
...
% ============================================================================
% Detail page: width scheduling and temporary reuse used inside phase 2
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);
...
% ============================================================================
% Page 5: phase 3, prepare X workspace
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);
...
% ============================================================================
% Page 2: inside one point-addition box
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);

  \node[font=\LARGE\bfseries] at (17.15,18.0)
    {Inside one window-controlled mixed point addition};
  \node[font=\large] at (17.15,17.35)
  ...
  \node[lab, anchor=east] at (1.9,11.35) {$X:\ \ket{x_R}$};
  \node[lab, anchor=east] at (1.9,8.75) {$Y:\ \ket{y_R}$};
  ...
  \node[note, anchor=east] at (32.9,12.0) {$X=x_{R'}$};
  \node[note, anchor=east] at (32.9,8.15) {$Y=y_{R'}$};
  ...
  \node[font=\large\bfseries, anchor=west] at (2.35,3.78)
    {Shared dialog-GCD machinery};
  \node[add, text width=42mm] (D1) at (5.6,2.55)
    {Jump-2 binary-GCD walk\\on $(p,\text{denominator})$};
  \node[add, text width=42mm] (D2) at (12.9,2.55)
    {record and compress\\branch/shift transcript};
  \node[add, text width=42mm] (D3) at (20.2,2.55)
    {reverse replay on\\the numerator register};
  \node[add, text width=55mm] (D4) at (28.1,2.55)
    {division produces $\lambda$; reverse use\\multiplies by $X$ and erases $\lambda$};
  \draw[flow] (D1.east) -- (D2.west);
  \draw[flow] (D2.east) -- (D3.west);
  \draw[flow] (D3.east) -- (D4.west);

  \node[note, text width=31cm, align=center] at (17.15,0.82)
    {When $u_j=0$, the table selects the identity $\mathcal O$ and the controlled arithmetic leaves $R$ unchanged.};
...
% ============================================================================
% Page 6: phase 4, specialized square
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);
...
% ============================================================================
% Page 7: phase 5, reverse dialog-GCD multiplication
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);
...
% ============================================================================
% Page 8: phase 6, recover affine output
% ============================================================================
\begin{tikzpicture}[x=1cm,y=1cm]
  \path[use as bounding box] (0,0) rectangle (34.3,18.6);
